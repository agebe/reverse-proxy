...
import io.github.agebe.rproxy.HttpRequestHandler;
import io.github.agebe.rproxy.RequestStatus;
import io.github.agebe.rproxy.ReverseProxy;
...
public class MyHandler implements HttpRequestHandler {
  ...
  public RequestStatus handle(HttpServletRequest request, HttpServletResponse response) {
    ReverseProxy.forwardRequestStreamResult("https://docker.gridqube.com", request, response);
